...
function Section2({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
    ...
    return (
        <motion.div style={{ scale, rotate }} className=' sticky top-4 h-screen w-full border border-primary rounded-xl p-8 grid gap-8 md:gap-4 grid-cols-1 md:grid-cols-[1.61fr_1fr] bg-white/50 backdrop-blur-sm'>
            <div>
                <h3 className=' text-3xl md:text-5xl font-bold text-black mb-8'>Stronger together, better for you </h3>
